def numbers_to_bin():
    ...
    for i in range(7):
        try:
            variable = int(input(
                input_text[i]))  # это строчка нужна для ввода и обработки ошибки, когда пользователь вводит не цифры
            ...
            # flag_error = True
            print('Паблитто Дауниттос, ты ввел недопустимый формат в ', massive_print[i])
            break
...
massive = False
while not massive:
    # если функция выдала ошибку то мы спрашиваем у пользователя и вводим флаг,отвечающий за продолжения или выход из цикла
